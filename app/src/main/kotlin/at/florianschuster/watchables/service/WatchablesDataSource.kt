...
import com.tailoredapps.androidutil.firebase.firestore.createObject
import com.tailoredapps.androidutil.firebase.firestore.liveLocalObject
import com.tailoredapps.androidutil.firebase.firestore.liveLocalObjectList
import com.tailoredapps.androidutil.firebase.firestore.localObject
import com.tailoredapps.androidutil.firebase.firestore.localObjectList
import com.tailoredapps.androidutil.firebase.firestore.updateField
import com.tailoredapps.androidutil.firebase.firestore.updateObject
...
class FirebaseWatchablesDataSource(
    ...
    override val watchablesObservable: Flowable<List<Watchable>> = sessionService.user
        ...
        .flatMapPublisher { it.liveLocalObjectList<Watchable>() }
        .subscribeOn(Schedulers.io())
    ...
    override fun watchableObservable(id: String): Flowable<Watchable> = sessionService.user
        .map { fireStore.watchables(it.uid).document(id) }
        .flatMapPublisher { it.liveLocalObject<Watchable>() }
        .subscribeOn(Schedulers.io())
    ...
    override val watchableSeasonsObservable: Flowable<List<WatchableSeason>> = sessionService.user
        ...
        .flatMapPublisher { it.liveLocalObjectList<WatchableSeason>() }
        .subscribeOn(Schedulers.io())
